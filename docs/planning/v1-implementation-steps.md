...
- **7a. MainBoard** — the daily page. Absorbs the standalone Gate and Inbox pages (gate
  ...
  destinations). Design approved 2026-08-20; prototype awaiting review.
...
| 7 | §2 goal 8 + D17 (quickstart as product); §10 WebUI consolidated around it (MainBoard absorbs gate+inbox; Courtyard Admin new); v1 acceptance |
